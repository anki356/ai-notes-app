...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC] dark:bg-[#0F172A] p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-blue-500/10 blur-[120px] -ml-40 -mt-40 pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-indigo-500/10 blur-[120px] -mr-40 -mb-40 pointer-events-none" />
      ...
      <div className="w-full max-w-md bg-white dark:bg-[#1E293B] rounded-3xl shadow-2xl p-8 relative z-10 border border-slate-200 dark:border-slate-800">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Join Cognition and start building your second brain</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">
            ...
            <Link href="/login" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-bold hover:underline transition-all">
              Sign in
            </Link>
          </p>
        </div>
